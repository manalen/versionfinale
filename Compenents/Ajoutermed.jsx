...
class Ajoutermed extends Component {
    constructor(props) {
        super(props)
        this.state = {
            login :'',
    ...
    render() {
        ...
        return (
            <div>
                <div className="container" style={{paddingTop:"50px",borderRadius: "10px",position: "absolute",width:"750px", left:"340px",top: "130px",borderStyle: "ridge",borderColor: "#D7D7D7",height: "450px", boxShadow:"10px 10px 5px grey"}}>
                    <Formik
                            ...
                            (props) => (
                                <Form>
                                    <fieldset className="form-group">
                                        ...
                                        <Field className="form-group" type="text" name="login" style={{borderRadius: "5px",borderColor:"rgba(215, 215, 215, 1)",height:"40px",position: "absolute",left: "215px", width: "400px"}}/>
                                    </fieldset>
                                    <fieldset className="form-group">
                                        <label style={{fontFamily:"cursive",color:"#4997D4",position:"absolute",left:"40px",top:"130px"}}>Mot de passe</label>
                                        <Field className="form-group" type="password" name="mdp" style={{borderRadius: "5px",borderColor:"rgba(215, 215, 215, 1)",height:"40px",position: "absolute",left: "215px",top:"130px", width: "400px"}} />
                                    </fieldset>
                                    <fieldset className="form-group">
                                        <label style={{fontFamily:"cursive",color:"#4997D4",position:"absolute",left:"40px",top:"205px"}}>Nom</label>
                                        <Field className="form-group" type="text" name="nom" style={{borderRadius: "5px",borderColor:"rgba(215, 215, 215, 1)",height:"40px",position: "absolute",left: "215px",top:"210px", width: "400px"}} />
                                    </fieldset>
                                    <fieldset className="form-group">
                                        <label style={{fontFamily:"cursive",color:"#4997D4",position:"absolute",left:"40px",top:"290px"}}>Prénom</label>
                                        <Field className="form-group" type="text" name="prenom" style={{borderRadius: "5px",borderColor:"rgba(215, 215, 215, 1)",height:"40px",position: "absolute",left: "215px",top:"290px", width: "400px"}} />
                                    </fieldset>
                                    <fieldset className="form-group">
                                        <label style={{fontFamily:"cursive",color:"#4997D4",position:"absolute",left:"40px",top:"370px"}}>Spécialité médicale</label>
                                        <Field className="form-group" type="text" name="spécialité" style={{borderRadius: "5px",borderColor:"rgba(215, 215, 215, 1)",height:"40px",position: "absolute",left: "215px",top:"370px", width: "400px"}} />
                                    </fieldset>
